...
const pages: PagesInterface = {
  home: {
    ...
    description:
      "We buld the fastest websites in the world with modern designs that will improve your user experience and decrease the bounce rates.",
    ogType: "website",
  ...
  about: {
    ...
    description:
      "We buld the fastest websites in the world with modern designs that will improve your user experience and increase conversion rate.",
    ogType: "article",
